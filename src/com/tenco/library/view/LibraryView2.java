...
public class LibraryView2 {
    ...
    private void returnBook() throws SQLException {
        ...
        System.out.print("반납하는 학생 ID : ");
        Integer returnStudentId = scanner.nextInt();
    ...
    private void borrowBooks() throws SQLException {
        ...
        if (bookName.isEmpty()) {
            System.out.println("존재하지 않는 도서 이름입니다");
        } else {
            System.out.println("===책 목록===");
            listBooks();
            System.out.println("대출할 책 ID 입력 : ");
    ...
    private void listStudents() throws SQLException {
        ...
        if (studentList.isEmpty()) {
            ...
            for (Student s : studentList) {
                System.out.printf("ID: %2d | %-8s | %-15s | %n",
                        s.getId(),
                        s.getName(),
                        s.getStudentId()
                );
